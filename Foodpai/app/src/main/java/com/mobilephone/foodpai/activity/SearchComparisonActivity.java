...
//                            else if (rightNutrition != null) {
//                                SearchCompeletFoodAdapter compeletFoodAdapter = new SearchCompeletFoodAdapter(SearchComparisonActivity.this, rightNutrition, true);
...
//                            }else if (leftBeanNutrition!=null){
//                                SearchCompeletFoodAdapter compeletFoodAdapter = new SearchCompeletFoodAdapter(SearchComparisonActivity.this, leftBeanNutrition, false);
//                                mlvCompelet.setAdapter(compeletFoodAdapter);
